...
(lib.mc_gift_box = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
(lib.mc_arrow = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
// stage content:
(lib.Giftbox_animation = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Gift box
	this.instance = new lib.mc_gift_box();
	this.instance.setTransform(609,462.6,1,1,0,0,0,80.5,92.6);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(39));

	// Arrow
	this.instance_1 = new lib.mc_arrow();
...
})(lib3 = lib3||{}, images3 = images3||{}, createjs1 = createjs1||{}, ss = ss||{});
var lib3, images3, createjs1, ss;